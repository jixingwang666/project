(function (global) {
  ...
  function createClient() {
    ...
    return {
      ...
      emitTriggerFire: function () {
        return emitControl("PlanCommand", { action: "triggerFire" });
      },
      emitTriggerWater: function () {
        return emitControl("PlanCommand", { action: "triggerWater" });
      },
      emitTriggerBoth: function () {
        return emitControl("PlanCommand", { action: "triggerBoth" });
      },
      emitStopAll: function () {
        return emitControl("PlanCommand", { action: "stopAll" });
      },
      ...
      getAllFrames: function (simulationId) {
        return request(
          "/api/simulations/" + encodeURIComponent(simulationId) + "/frames/all",
          { method: "GET" }
        );
      },
